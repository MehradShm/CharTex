...
# Chart-to-text
cd $SLURM_TMPDIR
cp /home/msm97/scratch/datasets/Benchmarks/Chart-to-text/pew/pew_data.json $SLURM_TMPDIR/data 
...
##statista
python /home/msm97/projects/def-enamul/msm97/Codebases/ChartInstruct/benchmark_finetuning/UniGemma_CTT_pew_filetune.py --model-path /home/msm97/scratch/model_checkpoints/CTT/pew/1/model-checkpoint-epoch=3-5600