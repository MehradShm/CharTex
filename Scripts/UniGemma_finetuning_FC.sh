...
python /home/msm97/projects/def-enamul/msm97/Codebases/ChartInstruct/benchmark_finetuning/UniGemma_OCQA_finetune.py --model-path /home/msm97/scratch/model_checkpoints/ins_tuning/model-checkpoint-epoch=2-104000 --context-length 512

# ChartFC
cp /home/msm97/scratch/datasets/Benchmarks/ChartFC/chartFC.json $SLURM_TMPDIR/data
unzip -q /home/msm97/scratch/datasets/ChartFC_Images.zip -d $SLURM_TMPDIR/data
cd $SLURM_TMPDIR
python /home/msm97/projects/def-enamul/msm97/Codebases/ChartInstruct/benchmark_finetuning/UniGemma_FC_finetune.py --model-path /home/msm97/scratch/model_checkpoints/ins_tuning/model-checkpoint-epoch=2-104000
