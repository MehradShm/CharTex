...
parser.add_argument('--benchmark-path', type=str, default = f"{base_dir}/data/CQABench", help='Path to the input json file')
...
parser.add_argument('--images-path', type=str, default=f'{base_dir}/data/', help='Path to the images Folder')
...
parser.add_argument('--checkpoint-steps', type=int, default=2000, help='Steps needed to record a checkpoint')
...
huh_ev = DonutDataset(args.benchmark_path, args.images_path, args.context_length, processor, split = 'validation', prompt_end_token = '</ins>')#, indices = list(range(4)))
