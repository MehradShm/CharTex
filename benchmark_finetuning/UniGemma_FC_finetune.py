...
parser.add_argument('--benchmark-path', type=str, default = f"{base_dir}/data/chartFC.json", help='Path to the input json file')
...
parser.add_argument('--output-path', type=str, default = "/home/msm97/scratch/model_checkpoints/FC/1", help='Path to the output folder')
parser.add_argument('--images-path', type=str, default=f'{base_dir}/data/charts_seaborn_v5', help='Path to the images Folder')
...
parser.add_argument('--checkpoint-steps', type=int, default=3176, help='Steps needed to record a checkpoint')
