...
huh_tr = DonutDataset(subset_path, image_folder, 1024, processor, split = 'train', prompt_end_token = '<s_answer>', indices = list(range(976092)))
huh_ev = DonutDataset(subset_path, image_folder, 1024, processor, prompt_end_token = '<s_answer>', indices = list(range(4)))

out_path = f"{base_dir}/work/results"
#out_path = "/home/msm97/outputs/2"
